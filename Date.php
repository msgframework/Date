...
class Date extends \DateTime
{
     ...
     * @throws \Exception
     */
    public static function getInstance(string $date = 'now', $tz = null): Date
    {
     ...
     *
     */
    public function getOffsetFromGmt(bool $hours = false)
    {
     ...
     *
     */
    public function monthToString(int $month, bool $abbr = false): string
    {
        switch ($month)
        {
            case 1:
